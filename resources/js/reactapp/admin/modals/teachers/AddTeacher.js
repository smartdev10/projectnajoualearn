...
import { CreateFormateur , fetchFormateurs } from "../../../store/actions/formateurs";
import { fetchDepartement } from "../../../store/actions/departements";
import { Notyf } from 'notyf';
const notyf = new Notyf();


const AddTeacher = ({  toggleAddModal , open  , currentPage , className }) => {
  ...
  const saveDepartement = () => {
      dispatch(CreateFormateur({data:{name,description, formation_id}}))
      .then(() => {
